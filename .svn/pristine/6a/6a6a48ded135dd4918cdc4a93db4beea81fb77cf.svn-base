...
class valida
{
	 ...
	 */
	public static function toBoolean($value, $includeTrueValue = null, $includeFalseValue = null) 
	{
	...
	/**
	 * Testa se algum dos campos em $listaTeste está vazio
	 *	
	 * @param string $array Array que deve ser buscado
	 * @param string $testList Lista de strings contendo nomes das variaveis que devem ser 
	 * @return array contendo nomes dos campos vazios, false se não tiver nenhum vazio.
	 */
	public static function emptyFields($array, $testList = null)
	{
		$arrVazios = array();
